...
public class Datbase_Account {
    SQLiteDatabase database;
    DatabaseHelper databaseHelper;
    private static Datbase_Account datbase_account;

    public Datbase_Account(Context context) {
        databaseHelper = DatabaseHelper.getDatabaseHelper(context);
    }

    public static Datbase_Account getDatbase_account(Context context) {
        if (datbase_account == null) {
            datbase_account = new Datbase_Account(context);
        }
        return datbase_account;
    }

    public void Open_Database_TaiKhoan() {
